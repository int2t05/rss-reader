"""GitHub Pages 发布测试:写入 docs/_posts/YYYY-MM-DD.md,带 Jekyll front matter。
...
def test_publisher_publish_creates_file(publisher: GitHubPagesPublisher):
    """发布简报:创建 YYYY-MM-DD.md,含 Jekyll front matter。"""
...
def test_publisher_creates_dir_if_not_exists(tmp_path: Path):
    ...
    assert (posts_dir / "2026-09-17.md").exists()
...
def test_publisher_front_matter_contains_title(publisher: GitHubPagesPublisher):
    ...
    file_content = (publisher.posts_dir / "2026-09-17.md").read_text(encoding="utf-8")
